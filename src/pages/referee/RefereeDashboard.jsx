...
import { Scale, Star, Clock } from 'lucide-react'
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="gs-card p-6 mb-8 animate-fade-in-up delay-row-1" style={{ opacity: 0, animationFillMode: 'forwards' }}>
            <div className="flex items-start gap-5">
              <div className="w-16 h-16 rounded-2xl bg-tertiary/10 border-2 border-tertiary/25 flex items-center justify-center shrink-0">
