  ...
  return (
    <div className="flex-grow pb-16 flex flex-col min-h-screen">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-8 py-3 hidden md:flex items-center gap-6 border-b border-outline-variant/10">
        ...
        <button
          onClick={() => alert('Leaderboard holds results from 2024 through 2026. Detailed reports are being prepared for release!')}
          className="flex items-center gap-2 text-on-surface-variant hover:text-primary text-xs font-semibold uppercase tracking-wider transition-all bg-transparent border-none cursor-pointer py-1"
        >
        ...
        <div className="relative z-20 w-full max-w-[1280px] mx-auto px-6 sm:px-8 flex flex-col items-start gap-5">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/10 border border-secondary/25 backdrop-blur-md">
            ...
            <span className="text-secondary font-mono text-xs tracking-[0.2em] font-bold uppercase">
              Leading Horse Race Management Platform
            </span>
          </div>

          <h1 className="font-serif text-4xl sm:text-5xl md:text-[58px] text-white font-bold leading-[1.1] max-w-3xl drop-shadow-xl">
            Where Champions{' '}
            <span className="text-secondary">Are Born</span>
          </h1>

          <p className="font-sans text-base sm:text-lg text-on-surface-variant max-w-xl leading-relaxed">
            Take control of the most elite stables. Train top-tier
            thoroughbred racehorses, compete in thrilling races, and
            cement your legend in the arena.
          </p>
          ...
          <div className="flex flex-wrap gap-8 mt-6 pt-6 border-t border-white/10">
            ...
            <div>
              ...
              <span className="block text-[11px] text-white/60 uppercase tracking-wider mt-0.5">Roles</span>
            </div>
            <div>
              <span className="text-2xl font-bold text-secondary">24/7</span>
              <span className="block text-[11px] text-white/60 uppercase tracking-wider mt-0.5">Monitoring</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 w-full max-w-[1280px] mx-auto px-6 sm:px-8 flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 gs-card-glow flex flex-col justify-between overflow-hidden">
          <div>
            ...
            <div className="p-6">
              <h2 className="font-serif text-3xl text-on-surface font-bold mb-3 leading-tight">
                Triple Crown Tournament<br />
                <span className="text-secondary">Prestige</span>
              </h2>
              <p className="text-on-surface-variant text-sm leading-relaxed mb-6">
                The most prestigious and thrilling tournament of this racing season.
                Only the finest elite stables are invited to compete for
                legendary glory.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                <div className="gs-card-surface p-4 flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-on-surface-variant text-[10px] block uppercase tracking-wider font-bold mb-0.5">Dates</span>
                ...
                <div className="gs-card-surface p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-on-surface text-xs font-bold">Ascot Virtual Racecourse</span>
                  </div>
                </div>
                ...
                <div className="gs-card-surface p-4 flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-on-surface-variant text-[10px] block uppercase tracking-wider font-bold mb-0.5">Number of Legs</span>
          ...
          <div className="p-6 pt-0">
            <button
              onClick={() => alert('The Tournament Hub is loading: qualifier registration and race schedules coming soon!')}
        ...
        <div className="w-full lg:w-[410px] gs-card flex flex-col">
          ...
          <div className="p-5 flex-1 flex flex-col justify-between">
            ...
            <div className="mt-5 pt-4 border-t border-outline-variant/20 text-center">
              <button
                onClick={() => alert('Leaderboard holds results from 2024 through 2026.')}
      ...
      <section className="py-12 w-full max-w-[1280px] mx-auto px-6 sm:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-on-surface-variant text-sm max-w-xl mx-auto">
            A comprehensive horse race management platform for fans of top-tier sport.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Track your entire stable operations, race schedules, and results in detail.',
            },
            {
              icon: <Users className="w-6 h-6 text-primary" />,
              title: 'Racing Community',
              desc: 'Connect with fellow horse racing enthusiasts, share experiences, and grow together.',
            },
            {
              icon: <Award className="w-6 h-6 text-secondary" />,
              title: 'Attractive Prizes',
              desc: 'Join tournaments with prize pools worth millions of GS and unlock exclusive rewards.',
            },
          ].map((feat, i) => (
