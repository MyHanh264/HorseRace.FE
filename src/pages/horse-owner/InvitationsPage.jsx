...
export default function InvitationsPage() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
      ...
      {/* Tabs */}
      <div className="flex gap-0 mt-6 mb-5 border-b border-white/10 overflow-x-auto">
        {TABS.map((tab) => (
          <button
            key={tab}
      ...
      {/* Table */}
      <div className="bg-[#161d2e] rounded-xl border border-white/8 overflow-x-auto">
        {/* Table header */}
        <div className="grid grid-cols-[2.2fr_1.6fr_1.6fr_1.1fr_1fr_1fr] px-6 py-3 border-b border-white/8 text-xs text-gray-500 uppercase tracking-wider min-w-[920px]">
          <div>Race</div>
          <div>Horse</div>
          <div>Jockey Name</div>
          <div>Sent Date</div>
        ...
        {loading ? (
          ...
          paginated.map((inv) => (
            <div
              ...
              className={`grid grid-cols-[2.2fr_1.6fr_1.6fr_1.1fr_1fr_1fr] px-6 py-4 items-center min-w-[920px]
