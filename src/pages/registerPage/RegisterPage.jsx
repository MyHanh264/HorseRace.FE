...
const PUBLIC_ROLES = [
  ...
  },
  {
    code: 'JOCKEY',
    title: 'Jockey',
    description: 'Receive invitations, confirm bookings, and track performance.',
    icon: '⚑',
  },
]
...
function validateClient(form) {
  ...
  if (!PUBLIC_ROLES.some((r) => r.code === form.roleCode)) return 'Invalid role.'
    ...
    <div className="register-page">
      ...
      <div className="register-visual">
        ...
        <div className="register-visual-content">
          ...
          <p>
            Create your account today and begin your journey with GrandStride.
          </p>
        </div>
      </div>
            ...
            <div className="register-success-card">
              {success.requiresApproval ? (
                <>
                  ...
                  <p>
                    The account for <strong>{success.fullName}</strong> is awaiting admin approval.
                  </p>
                ...
                <>
                  ...
                  <p>
                    Welcome, <strong>{success.fullName}</strong>. Email: <strong>{success.email}</strong>. Please log in to continue.
                  </p>
                  <div className="register-success-actions">
                    <Link
                      className="register-btn register-btn--primary"
            ...
            <form className="register-form" onSubmit={onSubmit} noValidate>
                  ...
                  <div className="register-grid">
                    ...
                    <label className="register-field register-field--full">
                      ...
                      <textarea
                        name="bio"
                        rows={3}
                        placeholder="Brief description of your racing experience..."
                        value={form.bio}
              ...
              <div className="register-actions">
                ...
                <p className="register-footnote">
                  Spectators receive <strong className="text-secondary">100 points</strong> to start.
                </p>
                <p className="register-footnote">
