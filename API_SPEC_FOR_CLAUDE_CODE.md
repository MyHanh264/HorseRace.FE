# HRS — Đặc tả API đầy đủ cho Frontend (Claude Code)

> **Mục đích:** tài liệu tham chiếu để Claude Code viết phần Frontend (React) gọi đúng Backend.
> Đọc file này trước khi nối API. Nguồn sự thật: code BE trong `HorseRaceManagementSystem/`.
